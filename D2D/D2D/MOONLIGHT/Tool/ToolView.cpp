...
void CToolView::OnInitialUpdate()
{
	...
	m_pObjectMgr->AddObject(OBJECT_BACK,CBack::Create(D3DXVECTOR3(WINCX * 0.5f, WINCY * 0.5f, 0.f),0 , this));
	m_pObjectMgr->AddObject(OBJECT_WALL, CWall::Create(D3DXVECTOR3(WINCX * 0.5f, WINCY * 0.5f, 0.f),0 , this));
